...
Route::get('/google',function(){return view('googlemap');});
...
Route::resource('course3','PhotoController');
Route::resource('course4','transac');
Route::get('/addlist', 'addlistcontroller@index');
Route::get('/4Notification', 'addlistcontroller@index1');
Route::get('/transaction', 'addlistcontroller@index2');
