            ...
            <table>
                <tbody><tr>
                    ...
                    <td width="40%" valign="" top="">
                       ...
                       {!! Form::open(array('url' => '3Add', 'files'=>true)) !!}
                            <br><br>
                            <br><br>
                            <select  name="tag">
                           ...
                           <input type="email" name="email" size="30" placeholder="Your email"> <br><br>
                           ...
                           <input type="text" name="description" size="25" placeholder="Description"> <br><br>
                            <input type="text" name="contact" size="25" placeholder="Contact no"><br><br>
                            <input type="text" name="price" size="25" placeholder="Price"><br><br>
